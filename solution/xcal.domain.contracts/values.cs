...
namespace reexmonkey.xcal.domain.contracts
{
    ...
    public interface IRECUR : IVALUE
    {
        ...
        /// </summary>
        IEnumerable<int> BYMONTHDAY { get; set; }
        ...
        /// </summary>
        IEnumerable<int> BYYEARDAY { get; set; }
        ...
        /// </summary>
        IEnumerable<int> BYWEEKNO { get; set; }

        /// <summary>
        /// Gets or sets the collection of months of the year. 
        /// Valid values are 1 to 12.
        /// </summary>
        IEnumerable<uint> BYMONTH { get; set; }
    ...
    ///// <summary>
    ///// Specifies the contract for identifying properties that contain a human-readable text.
    ///// Line breaks and special characters should be escaped by the BACKSLASH (\) character. 
    ///// </summary>
    //public interface string : IValueType 
    //{
    //    string VALUE { get; set; }
    //}
