...
namespace reexjungle.xcal.test.units.concretes
{
    public class EventTester : IEventTester
    {
        ...
        {
            var dateGenerator = new SequentialGenerator<DateTime> { IncrementDateBy = IncrementDate.Day, Direction = GeneratorDirection.Ascending };
            dateGenerator.StartingWith(new DateTime(2014, 06, 15));
            ...
            return Builder<VEVENT>.CreateListOfSize(n)
                ...
                .And(x => x.Start = new DATE_TIME(dateGenerator.Generate()))
